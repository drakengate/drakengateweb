  ...
  return (
    ...
    >
      <div className="flex md:flex-row   justify-center md:justify-between w-full">
        ...
        <div className="text-white flex justify-center p-4  md:p-12 text-3xl cursor-pointer  ">
          <Link className="md:pr-24" passHref={true} href="/story">
            read
          </Link>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex justify-center mt-12 flex-col items-center">
          <p className="text-3xl text-white pb-6">
            <Link target="_blank" href="https://whitepaper.drakengate.com">
              Whitepaper
            </Link>
          </p>

          <p className="text-3xl text-white  ">Join Now</p>
          ...
          <div className="text-white text-2xl mt-8">
            <Link
              className="underline"
              target="_blank"
              href="https://forms.gle/NPiS15wcCzedhbPT9"
            >
              Join our Team
            </Link>
          </div>
